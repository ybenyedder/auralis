...
function build(spec: ThemeSpec): Theme {
  ...
  const vars: Record<string, string> = {
    ...
    // --background is the OPAQUE fallback colour, resolved from the theme's solid
    // base for glass themes (spec.background === "transparent"). The live animated
    // backdrop shows through via `.app-stage`, which data-glass turns transparent —
    // but everything OUTSIDE that stage (sticky headers, the mobile chrome, popovers,
    // overlays) still reads --background and must stay opaque, so a glass theme reads
    // its solid base here rather than falling through to bare black.
...
const CLASSIC: ThemeSpec[] = [
  ...
  {
    id: "slate", label: "Ardoise", group: "classic",
    blurb: "Ardoise froide — un bleu-gris minéral sur graphite bleuté.",
    themeColor: "#0b0e12", swatch: ["#161b22", "#7A8CA3", "#AEBACB"],
    foreground: "#eef1f5", background: "#0b0e12", bgSolid: "#0b0e12",
    panel: "#11151b", panel2: "#161b22", panel3: "#1f2630", sidebar: "#0e1116",
    popover: "#141821", line: "rgba(174,186,203,0.12)", lineStrong: "rgba(174,186,203,0.22)",
    primary: "#7A8CA3", soft: "#AEBACB", deep: "#4A5A70", ring: "rgba(122,140,163,0.46)", eyebrow: "#AEBACB",
    paper: "#e6ebf1", ink: "#0c0f14",
    textMuted: "#9aa3b0", textFaint: "#697079",
  },
  {
    id: "moss", label: "Mousse", group: "classic",
    blurb: "Mousse forestière — un olive désaturé sur terre d'ombre.",
    themeColor: "#0c0f0a", swatch: ["#171c12", "#8A9A5B", "#B8C58A"],
    foreground: "#eef1e8", background: "#0c0f0a", bgSolid: "#0c0f0a",
    panel: "#12150d", panel2: "#171c12", panel3: "#212818", sidebar: "#0f120b",
    popover: "#151a10", line: "rgba(184,197,138,0.12)", lineStrong: "rgba(184,197,138,0.22)",
    primary: "#8A9A5B", soft: "#B8C58A", deep: "#5A6636", ring: "rgba(138,154,91,0.44)", eyebrow: "#B8C58A",
    paper: "#eef2df", ink: "#12160b",
    textMuted: "#9ba393", textFaint: "#6b7162",
  },
];
...
const COSMIC: ThemeSpec[] = [
  ...
  {
    id: "andromeda", label: "Andromède", group: "cosmic", glass: true,
    blurb: "Galaxie voisine — un tourbillon rose et indigo semé d'étoiles filantes.",
    themeColor: "#080611", swatch: ["#1a1140", "#c084fc", "#818cf8"],
    foreground: "#efeafb", background: "transparent", bgSolid: "#080611",
    panel: "rgba(26,17,56,0.56)", panel2: "rgba(34,22,70,0.64)", panel3: "rgba(44,30,86,0.72)",
    sidebar: "rgba(14,9,32,0.52)", popover: "rgba(20,13,44,0.92)",
    line: "rgba(192,132,252,0.16)", lineStrong: "rgba(192,132,252,0.30)",
    primary: "#c084fc", soft: "#e9d5ff", deep: "#7e22ce", ring: "rgba(192,132,252,0.55)", eyebrow: "#d8b4fe",
    paper: "#f3e8ff", ink: "#180a2e",
    textMuted: "rgba(220,214,242,0.66)", textFaint: "rgba(200,194,228,0.42)",
    backdrop: { kind: "galaxy", colors: ["#f472b6", "#818cf8", "#c084fc", "#fbbf24"], intensity: 1.05, meteors: 8 },
  },
  {
    id: "polaris", label: "Polaire", group: "cosmic", glass: true,
    blurb: "Étoile polaire — un champ d'étoiles blanches, argent et sobre.",
    themeColor: "#05070c", swatch: ["#0d131f", "#cbd5e1", "#f8fafc"],
    foreground: "#eef2f8", background: "transparent", bgSolid: "#05070c",
    panel: "rgba(13,19,31,0.56)", panel2: "rgba(18,26,42,0.64)", panel3: "rgba(26,36,56,0.72)",
    sidebar: "rgba(8,12,20,0.52)", popover: "rgba(12,18,30,0.92)",
    line: "rgba(203,213,225,0.14)", lineStrong: "rgba(203,213,225,0.26)",
    primary: "#cbd5e1", soft: "#f1f5f9", deep: "#64748b", ring: "rgba(203,213,225,0.5)", eyebrow: "#e2e8f0",
    paper: "#f1f5f9", ink: "#0a0f17",
    textMuted: "rgba(206,214,228,0.64)", textFaint: "rgba(188,198,214,0.40)",
    backdrop: { kind: "starfield", colors: ["#f8fafc", "#cbd5e1", "#e2e8f0"], intensity: 1.1 },
  },
  {
    id: "eclipse", label: "Éclipse", group: "cosmic", glass: true,
    blurb: "Couronne solaire — un halo d'ambre autour d'un disque d'encre.",
    themeColor: "#0b0702", swatch: ["#241606", "#f59e0b", "#fbbf24"],
    foreground: "#f7eede", background: "transparent", bgSolid: "#0b0702",
    panel: "rgba(32,20,8,0.56)", panel2: "rgba(42,26,10,0.64)", panel3: "rgba(54,34,14,0.72)",
    sidebar: "rgba(18,11,4,0.52)", popover: "rgba(26,16,6,0.92)",
    line: "rgba(245,158,11,0.16)", lineStrong: "rgba(245,158,11,0.30)",
    primary: "#f59e0b", soft: "#fcd34d", deep: "#b45309", ring: "rgba(245,158,11,0.55)", eyebrow: "#fbbf24",
    paper: "#fef3c7", ink: "#241505",
    textMuted: "rgba(232,216,192,0.66)", textFaint: "rgba(212,196,172,0.42)",
    backdrop: { kind: "galaxy", colors: ["#f59e0b", "#fbbf24", "#b45309", "#fde68a"], intensity: 0.8, meteors: 3 },
  },
  {
    id: "milkyway", label: "Voie lactée", group: "cosmic", glass: true,
    blurb: "Bras galactique — une poussière dense d'étoiles blanches et lavande.",
    themeColor: "#06060f", swatch: ["#12122a", "#c4b5fd", "#a5b4fc"],
    foreground: "#eeeefb", background: "transparent", bgSolid: "#06060f",
    panel: "rgba(20,20,44,0.56)", panel2: "rgba(26,26,56,0.64)", panel3: "rgba(34,34,72,0.72)",
    sidebar: "rgba(11,11,28,0.52)", popover: "rgba(16,16,38,0.92)",
    line: "rgba(196,181,253,0.15)", lineStrong: "rgba(196,181,253,0.28)",
    primary: "#a5b4fc", soft: "#e0e7ff", deep: "#6366f1", ring: "rgba(165,180,252,0.52)", eyebrow: "#c4b5fd",
    paper: "#e0e7ff", ink: "#0e0e24",
    textMuted: "rgba(216,216,240,0.66)", textFaint: "rgba(198,198,224,0.42)",
    backdrop: { kind: "galaxy", colors: ["#ffffff", "#c4b5fd", "#a5b4fc", "#e0e7ff"], intensity: 1.3, meteors: 2 },
  },
];
...
const VIVID: ThemeSpec[] = [
  ...
  {
    id: "lagoon", label: "Lagon", group: "vivid", glass: true,
    blurb: "Eaux tropicales — un maillage mouvant de turquoise et d'émeraude.",
    themeColor: "#03100f", swatch: ["#082625", "#14b8a6", "#5eead4"],
    foreground: "#e6f6f2", background: "transparent", bgSolid: "#03100f",
    panel: "rgba(8,30,28,0.56)", panel2: "rgba(11,40,37,0.64)", panel3: "rgba(15,52,48,0.72)",
    sidebar: "rgba(5,20,19,0.52)", popover: "rgba(8,28,26,0.92)",
    line: "rgba(20,184,166,0.16)", lineStrong: "rgba(20,184,166,0.30)",
    primary: "#14b8a6", soft: "#5eead4", deep: "#0f766e", ring: "rgba(20,184,166,0.5)", eyebrow: "#5eead4",
    paper: "#ccfbf1", ink: "#04211d",
    textMuted: "rgba(202,230,224,0.66)", textFaint: "rgba(184,212,206,0.42)",
    backdrop: { kind: "mesh", colors: ["#14b8a6", "#059669", "#22d3ee", "#2dd4bf"], intensity: 1 },
  },
  {
    id: "ultraviolet", label: "Ultraviolet", group: "vivid", glass: true,
    blurb: "Lueur UV — un violet électrique fumant dans le noir.",
    themeColor: "#0a0616", swatch: ["#1a0f36", "#8b5cf6", "#a78bfa"],
    foreground: "#efeafb", background: "transparent", bgSolid: "#0a0616",
    panel: "rgba(26,15,54,0.56)", panel2: "rgba(34,20,68,0.64)", panel3: "rgba(44,28,86,0.72)",
    sidebar: "rgba(14,8,30,0.52)", popover: "rgba(20,12,42,0.92)",
    line: "rgba(139,92,246,0.16)", lineStrong: "rgba(139,92,246,0.30)",
    primary: "#8b5cf6", soft: "#c4b5fd", deep: "#6d28d9", ring: "rgba(139,92,246,0.55)", eyebrow: "#a78bfa",
    paper: "#ede9fe", ink: "#160a2e",
    textMuted: "rgba(220,214,242,0.66)", textFaint: "rgba(200,194,228,0.42)",
    backdrop: { kind: "nebula", colors: ["#8b5cf6", "#6d28d9", "#4c1d95", "#a78bfa"], intensity: 0.75 },
  },
];

// ---------------------------------------------------------------------------
// AMBIANCE — particle moods: real falling snow, drifting petals, wandering
// fireflies, rising embers, slanting rain. Each is its own canvas engine in
// <ThemeBackdrop/>, now running on every platform (counts scale down on phones).
// ---------------------------------------------------------------------------
const AMBIANCE: ThemeSpec[] = [
  ...
  {
    id: "lanterns", label: "Lanternes", group: "ambiance", glass: true,
    blurb: "Fête nocturne — des lanternes ambrées flottent dans la pénombre.",
    themeColor: "#100803", swatch: ["#2a1408", "#fbbf24", "#f97316"],
    foreground: "#fbeede", background: "transparent", bgSolid: "#100803",
    panel: "rgba(40,20,8,0.56)", panel2: "rgba(52,26,10,0.64)", panel3: "rgba(66,34,14,0.72)",
    sidebar: "rgba(24,12,5,0.52)", popover: "rgba(32,16,7,0.92)",
    line: "rgba(251,191,36,0.16)", lineStrong: "rgba(251,191,36,0.30)",
    primary: "#fbbf24", soft: "#fde68a", deep: "#b45309", ring: "rgba(251,191,36,0.5)", eyebrow: "#fcd34d",
    paper: "#fef3c7", ink: "#2a1405",
    textMuted: "rgba(236,216,196,0.66)", textFaint: "rgba(216,196,176,0.42)",
    backdrop: { kind: "fireflies", colors: ["#fbbf24", "#f97316", "#ef4444", "#fcd34d"], intensity: 1 },
  },
  {
    id: "storm", label: "Orage", group: "ambiance", glass: true,
    blurb: "Tempête électrique — des traits bleu vif fendent un ciel d'ardoise.",
    themeColor: "#060a12", swatch: ["#0f1a2e", "#60a5fa", "#93c5fd"],
    foreground: "#e8eef8", background: "transparent", bgSolid: "#060a12",
    panel: "rgba(14,22,40,0.56)", panel2: "rgba(19,30,52,0.64)", panel3: "rgba(26,40,68,0.72)",
    sidebar: "rgba(8,13,24,0.52)", popover: "rgba(12,19,34,0.92)",
    line: "rgba(96,165,250,0.15)", lineStrong: "rgba(96,165,250,0.28)",
    primary: "#60a5fa", soft: "#93c5fd", deep: "#2563eb", ring: "rgba(96,165,250,0.52)", eyebrow: "#93c5fd",
    paper: "#dbeafe", ink: "#0a1220",
    textMuted: "rgba(206,216,232,0.64)", textFaint: "rgba(188,200,218,0.40)",
    backdrop: { kind: "rain", colors: ["#93c5fd", "#60a5fa", "#e0f2fe"], intensity: 1.1 },
  },
];
