...
export const MOODS: Mood[] = [
  {
    id: "energetic", label: "Énergie", blurb: "De quoi se booster",
  ...
  {
    id: "party", label: "Fête", blurb: "Monte le son",
  ...
  {
    id: "happy", label: "Bonne humeur", blurb: "Sourire garanti",
  ...
  {
    id: "focus", label: "Concentration", blurb: "Dans la zone",
  ...
  {
    id: "chill", label: "Détente", blurb: "Doux et posé",
  ...
  {
    id: "melancholy", label: "Mélancolie", blurb: "Pour les émotions",
