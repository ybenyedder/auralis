...
const threshold = LEVELS[(process.env.AURALIS_LOG_LEVEL as Level) ?? (process.env.NODE_ENV === "production" ? "info" : "debug")] ?? 20;
const asJson = process.env.AURALIS_LOG_FORMAT === "json" || process.env.NODE_ENV === "production";
