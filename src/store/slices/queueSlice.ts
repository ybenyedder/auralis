...
setNormalization: (mode) => {
      ...
      get().notify(
        translate(get().locale, mode === "off" ? "toast.normOff" : mode === "album" ? "toast.normAlbum" : "toast.normTrack"),
      );
    },
...
addToQueueNext: (track) => {
      ...
      get().notify(translate(get().locale, "toast.playNext", undefined, { title: track.title }));
    },
...
addToQueueEnd: (track) => {
      ...
      get().notify(translate(get().locale, "toast.addedToQueue", undefined, { title: track.title }));
    },
...
clearQueue: () => {
      ...
      get().notify(translate(get().locale, "toast.queueCleared"), {
        action: {
          label: translate(get().locale, "common.cancel"),
