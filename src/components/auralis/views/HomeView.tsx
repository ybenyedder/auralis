...
function QuickTile({
  ...
  return (
    ...
    >
      {liked ? (
        <span
          className="grid h-full w-[64px] shrink-0 place-items-center bg-[var(--primary)]"
        >
      ...
      <button
        ...
        className="signal-button mr-3 grid h-10 w-10 shrink-0 place-items-center rounded-full opacity-0 transition-all duration-200 group-hover:opacity-100"
      >
