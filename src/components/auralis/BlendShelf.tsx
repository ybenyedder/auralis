...
export function BlendShelf() {
  ...
  return (
    <section className="fade-up">
      <h2 className="mb-4 text-[20px] font-bold tracking-tight text-foreground lg:text-[24px]">{t("home.blend", "Blend du foyer")}</h2>
        ...
        {others.map((u) => {
          ...
          return (
            <button
              ...
              aria-label={t("home.blendWith", `Blend avec ${u}`, { user: u })}
            ...
            >
              ...
              <span className="pointer-events-none relative mt-2 block truncate text-[16px] font-bold text-white">{t("home.blendWith", `Blend avec ${u}`, { user: u })}</span>
              <span className="pointer-events-none relative mt-0.5 block text-[12px] font-semibold text-white/80">{t("home.blendTagline", "Vos goûts mélangés")}</span>
