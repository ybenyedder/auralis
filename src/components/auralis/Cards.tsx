    ...
    >
      <div className="relative">
        {coverImage ? (
          ...
          <div
            className="cover-fallback flex aspect-square w-full items-center justify-center overflow-hidden rounded-lg border-none"
            style={{ background: `linear-gradient(135deg, ${colors[0]}, ${colors[1] || '#1a1a1a'})` }}
          >
            <span className="relative p-4 text-center text-[18px] font-bold tracking-tight leading-tight text-white/95 drop-shadow-md line-clamp-3">
              {playlist.name}
            </span>
          </div>
        )}
