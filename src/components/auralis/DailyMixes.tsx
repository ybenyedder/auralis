      ...
      >
        {covers.length >= 4 ? (
          ...
          <span className="absolute inset-0 grid place-items-center">
            <Compass className="size-10 text-white/90 drop-shadow-[0_1px_3px_rgba(0,0,0,0.45)]" />
          </span>
        ) : null}
        <span className="signal-button glow-primary absolute bottom-2 right-2 grid h-11 w-11 translate-y-2 place-items-center rounded-full opacity-0 transition-all duration-200 group-hover:translate-y-0 group-hover:opacity-100">
