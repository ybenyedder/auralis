...
export function TitleBar() {
  ...
  return (
    ...
    >
      ...
      {/* Nav — simple chevrons (Apple Music style), tinted red when available. NOT draggable. */}
      ...
      {/* Search — a button that opens the command palette. Apple Music style:
          a rounded surface field, magnifier + label, no border clutter. */}
